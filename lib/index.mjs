...
// (304:4) {#if loading && direction === 'top'}
...
// (309:6) {#each visible as row (row.index)}
...
// (316:4) {#if loading && direction === 'bottom'}
...
// (320:2) {#if !loading && visible.length === 0}
