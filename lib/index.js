;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global['svelte-virtual-infinite-list'] = {})))
  ...
  /* src/VirtualInfiniteList.svelte generated by Svelte v3.35.0 */

  function add_css() {
    var style = element('style')
    style.id = 'svelte-1kggtm4-style'
    style.textContent =
      'virtual-infinite-list-viewport.svelte-1kggtm4{position:relative;overflow-y:auto;-webkit-overflow-scrolling:touch;display:block}virtual-infinite-list-contents.svelte-1kggtm4,virtual-infinite-list-row.svelte-1kggtm4{display:block}virtual-infinite-list-row.svelte-1kggtm4{overflow:hidden}'
  ...
  // (268:4) {#if loading && direction === 'top'}
  ...
  // (273:6) {#each visible as row (row.index)}
  ...
  // (282:4) {#if loading && direction === 'bottom'}
  ...
  function create_fragment(ctx) {
    ...
    if (~(current_block_type_index = select_block_type(ctx))) {
      if_block1 = if_blocks[current_block_type_index] = if_block_creators[current_block_type_index](
        ctx
      )
    }
    ...
    return {
      c() {
        ...
        add_render_callback(() =>
          /*virtual_infinite_list_viewport_elementresize_handler*/ ctx[25].call(
            virtual_infinite_list_viewport
          )
        )
      },
      m(target, anchor) {
        ...
        virtual_infinite_list_viewport_resize_listener = add_resize_listener(
          virtual_infinite_list_viewport,
          /*virtual_infinite_list_viewport_elementresize_handler*/ ctx[25].bind(
            virtual_infinite_list_viewport
          )
        )
        current = true
  ...
  so the offset after loaded may be significantly shift.`)
    ...
    $$self.$$set = ($$props) => {
      ...
      if ('maxItemCountPerLoad' in $$props)
        $$invalidate(15, (maxItemCountPerLoad = $$props.maxItemCountPerLoad))
    ...
    $$self.$$.update = () => {
      ...
      if ($$self.$$.dirty[0] & /*mounted, items, preItems*/ 401408) {
        $$invalidate(
          20,
          (newItemsLoaded =
            mounted && items && items.length > 0 && items.length - preItems.length > 0)
        )
      }
  ...
  exports.VirtualInfiniteList = VirtualInfiniteList
