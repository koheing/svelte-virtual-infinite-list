(function (global, factory) {
    ...
    // (394:4) {#if loading && direction === 'top'}
    ...
    // (399:6) {#each visible as row (row.index)}
    ...
    // (406:4) {#if loading && direction === 'bottom'}
    ...
    // (410:2) {#if !loading && visible.length === 0}
